...
class DataIngestionConfig:
    def __init__(self):
        ...
        self.ZIP_FILE_PATH = os.path.join(self.DATA_INGESTION_ARTIFACTS_DIR,self.ZIP_FILE_NAME)
         ...
         # Add logging for path validation
        logging.info(f"DATA_INGESTION_ARTIFACTS_DIR: {self.DATA_INGESTION_ARTIFACTS_DIR}")
        logging.info(f"ZIP_FILE_PATH: {self.ZIP_FILE_PATH}")
        logging.info(f"ZIP_FILE_DIR: {self.ZIP_FILE_DIR}")
        
        # Create directories if they don't exist
        if not os.path.exists(self.DATA_INGESTION_ARTIFACTS_DIR):
            os.makedirs(self.DATA_INGESTION_ARTIFACTS_DIR)
            logging.info(f"Created directory: {self.DATA_INGESTION_ARTIFACTS_DIR}")
